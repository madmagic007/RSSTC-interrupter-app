...
#define RX_VALUES       "33333333-3333-3333-3333-333333333333"
...
void reportValue(const String& name, u32_t value) {
    ...
    reportChars->setValue((uint8_t*)json.c_str(), json.length());
    reportChars->notify();
}

static void onCapabilityChanged(const String& name, uint32_t value) {
